...
//            System.exit(0);
            ...
            data.putString("message", "App已经从异常中恢复");
            MyApplication.restartApplication(mContext, data);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        DingTalkBotSenderUtil.postDingTalk(Constants.DING_TALK_BOT_TOKEN, String.format(Locale.CHINA, "[异常退出] %s\n\n%s", ex.getMessage(), sb.toString()));
